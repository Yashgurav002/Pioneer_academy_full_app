  ...
  return (
    <AppLayout>
      <div className="flex flex-col items-center justify-center h-[70vh] text-center">
        ...
        <h1 className="text-3xl font-bold dark:text-white mb-3">Documents Under Construction</h1>
        <p className="text-gray-500 dark:text-gray-400 mb-8 max-w-md">
          We are currently working on this feature. Check back later for centralized file sharing and policy downloads.
        </p>
        <button 
          onClick={() => router.back()}
